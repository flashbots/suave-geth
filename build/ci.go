...
import (
	...
	"github.com/flashbots/suave-geth/crypto/signify"
	"github.com/flashbots/suave-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/flashbots/suave-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/flashbots/suave-geth/internal/version.gitDate="+env.Date)
	}
