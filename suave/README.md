...
1. **Deploy smart contracts with off-chain execution capabilities.**  
   Similiar to the Ethereum network, the same rules apply to smart contracts in SUAVE. However, contracts on the SUAVE Chain have the added advantage of being able to access additional precompiles during off-chain request execution. To find the off-chain precompile reference, check the [**SUAVE library**](https://www.notion.so/SUAVE-library-76f0d90aa0104651aa6f5ec42697e8b9?pvs=21).
...
2. Craft your off-chain request. This is a regular Ethereum transaction, where you specify the contract address and it’s (public) calldata. I’m assuming you have found or deployed a smart contract which you intend to call off-chain. Don’t sign the transaction quite yet.
    ...
    For more on off-chain contracts see [TODO: Off-chain smart contracts](https://www.notion.so/TODO-Off-chain-smart-contracts-12eb9293a87e4ed69cc0ab4a1594c73c?pvs=21)
...
For more on off-chain transactions see [Off-chain transactions](https://www.notion.so/Off-chain-transactions-747ab87c3ad6434194d72b9abab13def?pvs=21).
...
The idea is similar to [(public) Carrier Transactions Spec](https://www.notion.so/public-Carrier-Transactions-Spec-a79ecbbeaa774a5da8673965be7d9cbe?pvs=21) and [Suave Orders](https://www.notion.so/Suave-Orders-d8ee7ff23a604de4910da4cafb21ff2a?pvs=21), slightly simpler.
