...
func (evm *EVM) precompile(addr common.Address) (PrecompiledContract, bool) {
	...
	if evm.chainRules.IsSuave && isPrecompileAddr(addr) {
		...
		// non-confidential precompiles
		// TODO: should be autogenerated from spec
		if p, ok := SuaveOnchainPrecompiles[addr]; ok {
			return p, ok
		}
	}
