...
type SuaveRuntime interface {
	...
	randomBytes(numBytes uint64) ([]byte, error)
	randomUint256() (*big.Int, error)
...
var (
	...
	randomUint256Addr         = common.HexToAddress("0x0000000000000000000000000000000077700256")
...
func (b *SuaveRuntimeAdapter) run(addr common.Address, input []byte) ([]byte, error) {
	...
	case randomUint256Addr:
		return b.randomUint256(input)
...
func (b *SuaveRuntimeAdapter) randomUint256(input []byte) (res []byte, err error) {
	var (
		unpacked []interface{}
		result   []byte
	)
	...
	unpacked, err = artifacts.SuaveAbi.Methods["randomUint256"].Inputs.Unpack(input)
	if err != nil {
		err = errFailedToUnpackInput
		return
	}
	...
	if value, err = b.impl.randomUint256(); err != nil {
		return
	}

	result, err = artifacts.SuaveAbi.Methods["randomUint256"].Outputs.Pack(value)
	if err != nil {
		err = errFailedToPackOutput
		return
	}
