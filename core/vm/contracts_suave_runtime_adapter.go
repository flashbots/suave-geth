...
type SuaveRuntime interface {
	...
	httpGet(url string, config types.HttpConfig) ([]byte, error)
	httpPost(url string, body []byte, config types.HttpConfig) ([]byte, error)
	jsonMarshal(abispec string, obj []byte) ([]byte, error)
	jsonUnmarshal(abispec string) ([]byte, error)
...
var (
	...
	jsonMarshalAddr              = common.HexToAddress("0x0000000000000000000000000000000173200001")
	jsonUnmarshalAddr            = common.HexToAddress("0x0000000000000000000000000000000163200001")
	...
	simpleConsoleAddr            = common.HexToAddress("0x0000000000000000000000000000000183200001")
...
var addrList = []common.Address{
	buildEthBlockAddr, confidentialInputsAddr, confidentialRetrieveAddr, confidentialStoreAddr, ethcallAddr, extractHintAddr, fetchBidsAddr, fillMevShareBundleAddr, httpGetAddr, httpPostAddr, jsonMarshalAddr, jsonUnmarshalAddr, newBidAddr, signEthTransactionAddr, simpleConsoleAddr, simulateBundleAddr, submitBundleJsonRPCAddr, submitEthBlockBidToRelayAddr,
}
...
func (b *SuaveRuntimeAdapter) run(addr common.Address, input []byte) ([]byte, error) {
	...
	case httpGetAddr:
		return b.httpGet(input)

	case httpPostAddr:
		return b.httpPost(input)

	case jsonMarshalAddr:
		return b.jsonMarshal(input)

	case jsonUnmarshalAddr:
		return b.jsonUnmarshal(input)
	...
	case simpleConsoleAddr:
		return b.simpleConsole(input)
...
func (b *SuaveRuntimeAdapter) httpGet(input []byte) (res []byte, err error) {
	var (
		unpacked []interface{}
		result   []byte
	)
	...
	unpacked, err = artifacts.SuaveAbi.Methods["httpGet"].Inputs.Unpack(input)
	if err != nil {
		err = errFailedToUnpackInput
		return
	}
	...
	if err = mapstructure.Decode(unpacked[1], &config); err != nil {
		err = errFailedToDecodeField
		return
	}
	...
	if getResult, err = b.impl.httpGet(url, config); err != nil {
		return
	}

	result, err = artifacts.SuaveAbi.Methods["httpGet"].Outputs.Pack(getResult)
	if err != nil {
		err = errFailedToPackOutput
		return
	}
...
func (b *SuaveRuntimeAdapter) httpPost(input []byte) (res []byte, err error) {
	var (
		unpacked []interface{}
		result   []byte
	)
	...
	unpacked, err = artifacts.SuaveAbi.Methods["httpPost"].Inputs.Unpack(input)
	if err != nil {
		err = errFailedToUnpackInput
		return
	}
	...
	url = unpacked[0].(string)
	body = unpacked[1].([]byte)

	if err = mapstructure.Decode(unpacked[2], &config); err != nil {
		err = errFailedToDecodeField
		return
	}
	...
	if postResult, err = b.impl.httpPost(url, body, config); err != nil {
		return
	}

	result, err = artifacts.SuaveAbi.Methods["httpPost"].Outputs.Pack(postResult)
	if err != nil {
		err = errFailedToPackOutput
		return
	}
...
func (b *SuaveRuntimeAdapter) jsonMarshal(input []byte) (res []byte, err error) {
	var (
		unpacked []interface{}
		result   []byte
	)
	...
	unpacked, err = artifacts.SuaveAbi.Methods["jsonMarshal"].Inputs.Unpack(input)
	if err != nil {
		err = errFailedToUnpackInput
		return
	}
	...
	if encodedObj, err = b.impl.jsonMarshal(abispec, obj); err != nil {
		return
	}

	result, err = artifacts.SuaveAbi.Methods["jsonMarshal"].Outputs.Pack(encodedObj)
	if err != nil {
		err = errFailedToPackOutput
		return
	}
...
func (b *SuaveRuntimeAdapter) jsonUnmarshal(input []byte) (res []byte, err error) {
	var (
		unpacked []interface{}
		result   []byte
	)
	...
	unpacked, err = artifacts.SuaveAbi.Methods["jsonUnmarshal"].Inputs.Unpack(input)
	if err != nil {
		err = errFailedToUnpackInput
		return
	}
	...
	if decodedObj, err = b.impl.jsonUnmarshal(abispec); err != nil {
		return
	}

	result, err = artifacts.SuaveAbi.Methods["jsonUnmarshal"].Outputs.Pack(decodedObj)
	if err != nil {
		err = errFailedToPackOutput
		return
	}
...
func (b *SuaveRuntimeAdapter) simpleConsole(input []byte) (res []byte, err error) {
	var (
		unpacked []interface{}
		result   []byte
	)
	...
	unpacked, err = artifacts.SuaveAbi.Methods["simpleConsole"].Inputs.Unpack(input)
	if err != nil {
		err = errFailedToUnpackInput
		return
	}
	...
	if err = b.impl.simpleConsole(obj); err != nil {
		return
	}
