...
// Hash: e5fd01ab775f407562325023bbd419e19a533cf988a68bb06bd1ec77ab06a9ae
package vm
...
type SuaveRuntime interface {
	...
	secp256k1Decrypt(privateKey common.Hash, ciphertext []byte) ([]byte, error)
	secp256k1Encrypt(pubkey []byte, message []byte) ([]byte, error)
...
func (b *SuaveRuntimeAdapter) secp256k1Decrypt(input []byte) (res []byte, err error) {
	...
	privateKey = unpacked[0].(common.Hash)
	...
	if message, err = b.impl.secp256k1Decrypt(privateKey, ciphertext); err != nil {
		return
	}
...
func (b *SuaveRuntimeAdapter) secp256k1Encrypt(input []byte) (res []byte, err error) {
	...
	if ciphertext, err = b.impl.secp256k1Encrypt(pubkey, message); err != nil {
		return
	}
