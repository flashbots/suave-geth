...
// Hash: a555f0a02035543c17d43ed94483f884d2dc24c511b6fa6bc1d119a5761a1f11
package vm
...
type SuaveRuntime interface {
	aesDecrypt(ciphertext []byte, cipher common.Hash) error
	aesEncrypt(key common.Hash, message []byte) ([]byte, error)
...
func (b *SuaveRuntimeAdapter) aesDecrypt(input []byte) (res []byte, err error) {
	...
	cipher = unpacked[1].(common.Hash)

	var ()

	if err = b.impl.aesDecrypt(ciphertext, cipher); err != nil {
		return
	}
