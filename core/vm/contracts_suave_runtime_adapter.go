...
// Hash: b40a92d5101626be7d7a6ecb1a79ebe8fa4f6d1ed29f856bddf921eb1be51340
package vm
...
type SuaveRuntime interface {
	...
	simulateBundle(sessionid string, bundle []byte) (types.SimulateBundleResult, error)
...
func (b *SuaveRuntimeAdapter) simulateBundle(input []byte) (res []byte, err error) {
	...
	var (
		simulationResult types.SimulateBundleResult
	)

	if simulationResult, err = b.impl.simulateBundle(sessionid, bundle); err != nil {
		return
	}

	result, err = artifacts.SuaveAbi.Methods["simulateBundle"].Outputs.Pack(simulationResult)
	if err != nil {
		err = errFailedToPackOutput
		return
	}
