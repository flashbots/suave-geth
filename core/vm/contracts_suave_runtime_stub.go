...
func (b *BackendStub) buildEthBlock(input []byte) ([]byte, error) {
	...
	packedRes, err := PrecompilesAbi.Methods["buildEthBlock"].Outputs.Pack(res0, res1)
	if err != nil {
		return nil, err
	}
...
func (b *BackendStub) confidentialStoreRetrieve(input []byte) ([]byte, error) {
	...
	unpacked, err := PrecompilesAbi.Methods["confidentialStoreRetrieve"].Inputs.Unpack(input)
	if err != nil {
		return nil, err
	}
...
func (b *BackendStub) confidentialStoreStore(input []byte) ([]byte, error) {
	...
	unpacked, err := PrecompilesAbi.Methods["confidentialStoreStore"].Inputs.Unpack(input)
	if err != nil {
		return nil, err
	}
...
func (b *BackendStub) fetchBids(input []byte) ([]byte, error) {
	...
	unpacked, err := PrecompilesAbi.Methods["fetchBids"].Inputs.Unpack(input)
	if err != nil {
		return nil, err
	}
	...
	packedRes, err := PrecompilesAbi.Methods["fetchBids"].Outputs.Pack(res0)
	if err != nil {
		return nil, err
	}
	return packedRes, nil
...
func (b *BackendStub) newBid(input []byte) ([]byte, error) {
	...
	unpacked, err := PrecompilesAbi.Methods["newBid"].Inputs.Unpack(input)
	if err != nil {
		return nil, err
	}
	...
	packedRes, err := PrecompilesAbi.Methods["newBid"].Outputs.Pack(res0)
	if err != nil {
		return nil, err
	}
	return packedRes, nil
...
func (b *BackendStub) simulateBundle(input []byte) ([]byte, error) {
	...
	packedRes, err := PrecompilesAbi.Methods["simulateBundle"].Outputs.Pack(res0)
	if err != nil {
		return nil, err
	}
	return packedRes, nil
