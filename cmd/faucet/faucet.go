...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *goerliFlag, *rinkebyFlag, *sepoliaFlag, *suaveFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, goerliFlag bool, rinkebyFlag bool, sepoliaFlag bool, suaveFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
