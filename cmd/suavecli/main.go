...
func main() {
	var (
		suaveRpc                = flag.String("suave_rpc", "http://127.0.0.1:8545", "address of suave rpc")
		executionNodeAddressHex = flag.String("ex_node_addr", "0x4E2B0c0e428AE1CDE26d5BcF17Ba83f447068E5B", "wallet address of execution node")
		goerliRpc               = flag.String("goerli_rpc", "http://127.0.0.1:8545", "address of goerli rpc")
		privKeyHex              = flag.String("privkey", "", "private key as hex (for testing)")
